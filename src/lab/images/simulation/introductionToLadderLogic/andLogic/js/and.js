				...
				setTimeout(function()
				{
					...
					setTimeout(function()
					{
						...
						setTimeout(function()
						{
							...
							setTimeout(function()
							{
								document.getElementById("a2").style="position:absolute; left:326px; top:367.5px; visibility:visible";
								setTimeout(function()
								{
									document.getElementById("i22").innerHTML="1";
									document.getElementById("i22").style.visibility="visible";
									setTimeout(function()
									{
										...
										setTimeout(function()
										{
											...
											setTimeout(function()
											{
												document.getElementById("a2").style="position:absolute; left:380px; top:367.5px; visibility:visible";
												setTimeout(function()
												{
