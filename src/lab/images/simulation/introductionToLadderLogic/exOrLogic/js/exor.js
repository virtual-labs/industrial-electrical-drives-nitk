		...
		setTimeout(function()
		{
			...
			setTimeout(function()
			{
				...
				setTimeout(function()
				{
					...
					document.getElementById("c1").style.animation="rotateLineForward 1.5s forwards";
					setTimeout(function()
					{
						...
						setTimeout(function()
						{
							...
							setTimeout(function()
							{
								...
								document.getElementById("c3").style.animation="rotateLineReverse 1.5s forwards";
								setTimeout(function()
								{
									document.getElementById("i41").innerHTML="open";
...
function initSet()
{
	...
	document.getElementById("c3").style.transformOrigin="left bottom";
	document.getElementById("c3").style.transform="rotate(28deg)";
	document.getElementById("c3").style.visibility="visible";
	document.getElementById("c2").style.visibility="visible";
}
