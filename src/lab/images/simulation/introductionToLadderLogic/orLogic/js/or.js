...
function s1s2off()
{
	c=1;
	initSet();
	document.getElementById("header").innerHTML="When S<sub>1</sub> is OFF and S<sub>2</sub> is OFF, light doesn't glow";
	setTimeout(function()
	{
...
function s1OnANDs2Off()
{
	...
	setTimeout(function()
	{
		...
		setTimeout(function()
		{
			...
			setTimeout(function()
			{
				document.getElementById("a2").style="position:absolute; left:217.5px; top:292px;  visibility:visible;";
				setTimeout(function()
				{
					...
					setTimeout(function()
					{
						...
						setTimeout(function()
						{
							document.getElementById("a2").style="position:absolute; left:290px; top:292px;  visibility:visible;";
							setTimeout(function()
							{
								document.getElementById("i21").innerHTML="open";
								document.getElementById("i21").style.visibility="visible";
	...
	setTimeout(function()
	{
		...
		setTimeout(function()
		{
			...
			setTimeout(function()
			{
				...
				setTimeout(function()
				{
					document.getElementById("a3").style="position:absolute; left:217px; top:342px; transform:rotate(90deg); visibility:visible;";
					setTimeout(function()
					{
						...
						setTimeout(function()
						{
							...
							setTimeout(function()
							{
								document.getElementById("a3").style="position:absolute; left:292.5px; top:341px; transform:rotate(0deg); visibility:visible;";
								setTimeout(function()
								{
									document.getElementById("a3").style.visibility="hidden";
								},1000);
...
function finalOutput()
{
	setTimeout(function()
	{
		document.getElementById("a2").style="position:absolute; left:335px; top:292px; visibility:visible";
		setTimeout(function()
		{
			document.getElementById("a2").style.visibility="hidden";
			...
			setTimeout(function()
			{
				document.getElementById("a2").style="position:absolute; left:440px; top:292px; visibility:visible";
				setTimeout(function()
				{
