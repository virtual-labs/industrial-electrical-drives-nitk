...
function s1OnANDs2Off()
{
	c=2;
	initSet();
	document.getElementById("header").innerHTML="When S<sub>1</sub> is ON and S<sub>2</sub> is OFF, light glows";
	setTimeout(function()
	{
...
function s1OffANDs2On()
{
	c=3;
	initSet();
	document.getElementById("header").innerHTML="When S<sub>1</sub> is OFF and S<sub>2</sub> is ON, light glows";
	setTimeout(function()
	{
